  ...
  return knex('rooms').del()
    .then(function () {
      ...
      return knex('rooms').insert([
        ...
        { id: 36, house_id: 16, description: '1 queen bed', available: false },
        ...
        { id: 46, house_id: 19, description: '1 queen bed', available: false },
        ...
        { id: 58, house_id: 24, description: '2 double beds, 1 bunk bed', available: false },
        ...
        { id: 71, house_id: 28, description: '1 single bed', available: false },
        ...
        { id: 95, house_id: 36, description: '6 bunk beds', available: false },
        ...
        { id: 105, house_id: 41, description: '6 bunk beds', available: false },
        ...
        { id: 122, house_id: 48, description: '2 double beds, 1 bunk bed', available: false },
