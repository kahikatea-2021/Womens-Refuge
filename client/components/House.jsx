        ...
        <div className="">
          <div className="flex flex-col">
            ...
            <div className="flex items-center justify-center flex-col md:flex-row">
              ...
              {(ourUser?.isAdmin === true || ourUser?.house_id === house[0].house_id) && <div className="invisible hidden md:block mx-2"><ManageHouseButton text='EDIT' path={house[0].house_id} /></div>}
              <p className="text-center text-3xl md:text-5xl font-bold">{house[0].name}</p>
              {(ourUser?.isAdmin === true || ourUser?.house_id === house[0].house_id) && <div className="mx-2"><ManageHouseButton text='EDIT' path={house[0].house_id} /></div>}
            </div>
            ...
            {(ourUser && ourUser.isAdmin === true) && <div className="flex flex-col justify-center items-center">
